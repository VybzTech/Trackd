...
Note: an earlier pass in this repo briefly wired in a different, unrelated "Halo" design system pulled from a claude.ai/design project. That wiring was reverted — `docs/Trackd.md` is the system actually in use.
