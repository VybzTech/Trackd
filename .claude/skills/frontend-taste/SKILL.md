---
name: frontend-taste
description: Encodes a specific, non-generic frontend design taste — Vercel/Linear-grade restraint, precise motion, and modern CSS craft — that this user wants applied by default, not just when explicitly asked for "good design." Use this whenever building, reviewing, or advising on any UI, component, landing page, design system, or frontend code, including work inside Claude Design or Claude Code. Also consult this before choosing fonts, colors, spacing, shadows, or animation timing for any frontend output, and when reviewing someone else's frontend work for quality or "does this look generic."
---
